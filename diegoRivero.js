...
let ver_carrito = document.getElementById("mostrar_carrito");

ver_carrito.addEventListener("click" , function(){
...
function borrar_fila(e){
    ...
    let nombre = abuelo.cells[1].innerText;
    let talle = abuelo.cells[3].innerText;
    let carrito = JSON.parse(localStorage.getItem("carrito"));
    let toDelete = carrito.find(x => x.name === nombre);
